...
export const InputFormik: React.FC<React.DetailedHTMLProps<React.InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>> = (props) => {
    ...
    return (
        ...
        >
            <input
                ...
                style={{ width: '100%' }}
            />
            <span style={{ fontSize: '60%', color: 'red' }}>{hasError ? meta.error : ''}</span>
        </div>
    );
};
